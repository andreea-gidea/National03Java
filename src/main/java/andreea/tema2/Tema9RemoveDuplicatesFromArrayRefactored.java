...
public class Tema9RemoveDuplicatesFromArrayRefactored {
    public static void main(String[] args) {
        int[] initial = {20, 20, 30, 40, 50, 50, 50, 70};
        int[] finalArray=removeDuplicates(initial);
        for (int i=0;i<finalArray.length;i++){
            System.out.print(" "+finalArray[i]);
        }
    }

    public static int[] removeDuplicates(int[] initial) {
